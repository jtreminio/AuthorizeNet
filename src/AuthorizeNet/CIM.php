...
class CIM extends Request
{
     ...
     *
     * @param CIM\Customer $customerProfile
     ...
     * @param CIM\PaymentProfile $paymentProfile
     * @param string                     $validationMode
     *
     * @return CIM\Response
     */
     ...
     *
     * @param int         $customerProfileId
     * @param CIM\Address $shippingAddress
     *
     * @return CIM\Response
     */
     ...
     * @param CIM\Transaction $transaction
    ...
    {
        return new CIM\Response($response);
    }
     ...
     * @param mixed             $object      An object, array or value.
     */
