...
class AIM extends Request
{
     ...
     *
     * @param string|bool $amount   The dollar amount to charge
     * @param string|bool $card_num The credit card number
     * @param string|bool $exp_date CC expiration date
     *
     * @return AIM\Response
     */
     ...
     *
     * @param string|bool $trans_id Transaction id to charge
     * @param string|bool $amount   Dollar amount to charge if lesser than auth
     *
     * @return AIM\Response
     */
     ...
     * tender, then set x_split_tender_id manually.)
     *
     * @param string|bool $trans_id Transaction id to void
     *
     * @return AIM\Response
     */
     ...
     *
     * @param string|bool $auth_code The auth code
     * @param string|bool $amount    The dollar amount to charge
     * @param string|bool $card_num  The last 4 of credit card number
     * @param string|bool $exp_date  CC expiration date
     *
     * @return AIM\Response
     */
     ...
     *
     * @param string|bool $trans_id Transaction id to credit
     * @param string|bool $amount   The dollar amount to credit
     * @param string|bool $card_num The last 4 of credit card number
     *
     * @return AIM\Response
     */
    ...
    {
        return new AIM\Response($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
