...
class TD extends Request
{
     ...
     *
     * @param bool|bool   $includeStatistics
     * @param string|bool $firstSettlementDate //  yyyy-mmddTHH:MM:SS
     * @param string|bool $lastSettlementDate  //  yyyy-mmddTHH:MM:SS
     * @param bool|bool   $utc                 //  Use UTC instead of merchant time zone setting
     *
     * @return TD\Response
     */
    ...
    {
        return new TD\Response($response);
    }
